...
Public Class CRBuktiPembayaranPiutang
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "CRBuktiPembayaranPiutang.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Bengkel.CRBuktiPembayaranPiutang.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_kd_pembayaran() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedCRBuktiPembayaranPiutang
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRBuktiPembayaranPiutang = New CRBuktiPembayaranPiutang()
        rpt.Site = Me.Site
        Return rpt
    End Function
