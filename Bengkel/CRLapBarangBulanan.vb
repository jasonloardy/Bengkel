...
Public Class CRLapBarangBulanan
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Bengkel.CRLapBarangBulanan.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRLapBarangBulanan
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRLapBarangBulanan = New CRLapBarangBulanan()
        rpt.Site = Me.Site
        Return rpt
    End Function
