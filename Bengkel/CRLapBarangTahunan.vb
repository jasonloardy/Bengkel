...
Public Class CRLapBarangTahunan
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Bengkel.CRLapBarangTahunan.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_trx() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedCRLapBarangTahunan
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRLapBarangTahunan = New CRLapBarangTahunan()
        rpt.Site = Me.Site
        Return rpt
    End Function
