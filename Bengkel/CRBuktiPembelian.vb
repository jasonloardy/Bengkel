...
Public Class CRBuktiPembelian
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Bengkel.CRBuktiPembelian.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_kd_pembelian() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedCRBuktiPembelian
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRBuktiPembelian = New CRBuktiPembelian()
        rpt.Site = Me.Site
        Return rpt
    End Function
