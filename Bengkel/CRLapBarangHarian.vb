...
Public Class CRLapBarangHarian
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Bengkel.CRLapBarangHarian.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRLapBarangHarian
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRLapBarangHarian = New CRLapBarangHarian()
        rpt.Site = Me.Site
        Return rpt
    End Function
