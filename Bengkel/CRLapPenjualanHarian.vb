...
Public Class CRLapPenjualanHarian
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "CRLapPenjualanHarian.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Bengkel.CRLapPenjualanHarian.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_tanggal1() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedCRLapPenjualanHarian
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRLapPenjualanHarian = New CRLapPenjualanHarian()
        rpt.Site = Me.Site
        Return rpt
    End Function
